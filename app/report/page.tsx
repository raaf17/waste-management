            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-lg mb-12">
                ...
                {preview && (
                    <div className="mt-4 mb-8">
                        <img src={preview} alt="Waste preview" className="max-w-full h-auto rounded-md shadow-md" />
                    </div>
                )}
                ...
                <Button
                    ...
                    className="w-full mb-8 bg-blue-600 hover:bg-blue-700 text-white py-5 text-md rounded-md transition-colors duration-300"
                ...
                <Button
                    type="submit"
                    className="w-full bg-green-600 hover:bg-green-700 text-white py-5 text-md rounded-md transition-colors duration-300 flex items-center justify-center"
