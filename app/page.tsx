...
function AnimatedGlobe() {
  return (
    <div className="relative w-32 h-32 mx-auto mb-8">
      ...
      <div className="absolute inset-2 rounded-full bg-green-400 opacity-50 animate-ping"></div>
    ...
    <div className="container mx-auto px-4 py-16">
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Kipli Dev <span className="text-green-600">Waste Management</span>
        </h1 >
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        <FeatureCard icon={Leaf} title="Eco-Friendly" description="We are commited to reducing waste and promoting sustainability." />
        <FeatureCard icon={Coins} title="Earn Rewards" description="We are commited to reducing waste and promoting sustainability." />
        <FeatureCard icon={Leaf} title="Community Driven" description="We are commited to reducing waste and promoting sustainability." />
      </section>
...
function ImpactCard({ title, value, icon: Icon }: { title: string; value: string | number; icon: React.ElementType }) {
  return (
    <div className="p-6 rounded-xl bg-gray-50 border-gray-100 transition-all duration-200 ease-in-out hover:shadow-md">
